...
private:
	...
	const Scalar lowerThreshold1 = Scalar(0, 100, 20);
	const Scalar upperThreshold1 = Scalar(10, 255, 255);
	const Scalar lowerThreshold2 = Scalar(160,100,20);
	const Scalar upperThreshold2 = Scalar(179,255,255);
...
public:
	...
	void apply_red(const Mat& dst, const Mat& src) {
		...
		Mat red_mask_1;
		inRange(mMat, lowerThreshold1, upperThreshold1, red_mask_1);
		Mat red_mask_2;
		inRange(mMat, lowerThreshold2, upperThreshold2, red_mask_2);
	...
	void apply(const Mat &dst, const Mat &src) {
		...
		inRange(mMat, lowerThreshold1, upperThreshold1, red_mask_1);
		Mat red_mask_2;
		inRange(mMat, lowerThreshold1, upperThreshold1, red_mask_2);
		mMat = red_mask_1 + red_mask_2;*/
