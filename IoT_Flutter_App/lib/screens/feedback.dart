          ...
          return Container(
            child: DataTable(
              columns: const <DataColumn>[
                ...
                DataColumn(label: Text('My history')),
                DataColumn(label: Text('Student Email')),
                DataColumn(label: Text('Student Keys')),
            ...
            DataCell(Text(convert(e.value['teacherKeys'].toList()).toString().replaceAll(',','  |  ').replaceAll('[','').replaceAll(']',''))),
                DataCell(Text(e.value['studentEmail'])),
                DataCell(Text(convert(e.value['studentKeys'].toList()).toString().replaceAll(',','  |  ').replaceAll('[','').replaceAll(']',''))),
                ...
                if(doc_str ==widget._docId )
                  return Theme.of(context).colorScheme.primary.withOpacity(0.88);
/*
                else {
                  if(lengthDiff==0)
